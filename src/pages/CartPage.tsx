                  ...
                  <div className="flex-grow flex flex-col">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <button
                          onClick={() => navigate(`/product/${item.product.id}`)}
                          className="text-lg font-semibold text-gray-900 hover:text-primary-600 transition-smooth text-left"
                        >
                          {item.product.title}
                        </button>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-soft border border-gray-100 p-6 sticky top-24">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition-smooth shadow-soft hover:shadow-medium"
                >
                  Finalizar compra
                </button>
              </div>
